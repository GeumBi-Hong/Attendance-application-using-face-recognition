...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mqttAndroidClient.setCallback(new MqttCallback() {  //클라이언트의 콜백을 처리하는부분
            ...
            public void messageArrived(String topic, MqttMessage message) throws Exception {   //모든 메시지가 올때 Callback method
                if (topic.equals("kitae")){     //topic 별로 분기처리하여 작업을 수행할수도있음
        ...
        alert.setPositiveButton("확인", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int whichButton) { //확인 버튼을 클릭 했을 때
    ...
    private void stopRecordingVideo() {
        ...
        for (int i=0;i<40;i++){
            Bitmap bitmap = mediaMetadataRetriever.getFrameAtTime(i*250000); //영상으로부터 사진 추출

            SimpleDateFormat sdf = new SimpleDateFormat("yyyyMMddhhmmss");   //현재 시간으로 파일명 지정
